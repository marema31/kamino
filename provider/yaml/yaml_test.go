...
func TestOk(t *testing.T) {
	...
	saver, err := yaml.NewSaver(context.Background(), &dest)
	if err != nil {
		t.Fatalf("NewSaver should not return error and returned '%v'", err)
	}
	loader, err := yaml.NewLoader(context.Background(), &source)
	if err != nil {
...
func TestOpenError(t *testing.T) {
	...
	_, err := yaml.NewSaver(context.Background(), &dest)
	if err == nil {
		t.Fatalf("NewSaver should return error")
	}

	_, err = yaml.NewLoader(context.Background(), &source)
	if err == nil {
