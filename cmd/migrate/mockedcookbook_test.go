...
func (ck *mockedCookbook) Load(ctx context.Context, log *logrus.Entry, path string, limitedTags []string, recipes []string, stepNames []string, stepTypes []string) error {
	ck.called = false
	return ck.errorLoad
}
