...
func setupDo(path string, filename string) (context.Context, *logrus.Entry, datasource.Datasourcers, *viper.Viper) {
	_ = os.Mkdir("testdata/tmp", os.ModeDir|os.ModePerm)
