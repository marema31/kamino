...
func TestStepLoadError(t *testing.T) {
	...
	_, _, err := sf.Load(ctx, log, "testdata/fail", "nofolder", dss, prov, []string{}, []string{}, true, false)
	if err == nil {
		t.Errorf("Load should returns an error")
	}

	_, _, err = sf.Load(ctx, log, "testdata/fail", "dummy", dss, prov, []string{}, []string{}, true, false)
	if err == nil {
		t.Errorf("Load should returns an error")
	}

	_, _, err = sf.Load(ctx, log, "testdata/fail", "notype", dss, prov, []string{}, []string{}, true, false)
	if err == nil {
		t.Errorf("Load should returns an error")
	}

	_, _, err = sf.Load(ctx, log, "testdata/fail", "unknown", dss, prov, []string{}, []string{}, true, false)
	if err == nil {
		t.Errorf("Load should returns an error")
	}
}
func TestStepLoadMigrationOk(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "migrationok", dss, prov, []string{}, []string{}, true, false)
	if err != nil {
...
func TestStepLoadShellOk(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "shellok", dss, prov, []string{}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepLoadSqlscriptOk(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "sqlscriptok", dss, prov, []string{}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepLoadSyncOk(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "syncok", dss, prov, []string{}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepLoadTmplOk(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepNameFound(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{"nametmplok"}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepNameNotFound(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{"unknown"}, []string{}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepTypeFound(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{}, []string{"template"}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestStepTypeNotFound(t *testing.T) {
	...
	priority, steps, err := sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{}, []string{"shell"}, true, false)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
	...
	_, _, err = sf.Load(ctx, log, "testdata/good", "tmplok", dss, prov, []string{}, []string{"unknown"}, true, false)
	if err == nil {
		t.Errorf("Load should returns an error")
	}
}
