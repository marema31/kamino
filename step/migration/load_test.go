...
func TestMigrationLoadOk(t *testing.T) {
	...
	priority, steps, err := migration.Load(ctx, log, "testdata/good", "namemigrationok", 0, v, dss, false, false, nil)
	if err != nil {
...
func TestMigrationLoadNoTag(t *testing.T) {
	...
	priority, steps, err := migration.Load(ctx, log, "testdata/good", "notags", 0, v, dss, false, false, nil)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
...
func TestMigrationLoadNoFolder(t *testing.T) {
	...
	_, _, err = migration.Load(ctx, log, "testdata/fail", "nofolder", 0, v, dss, false, false, nil)
	if err == nil {
...
func TestMigrationLoadDFolderTemplateWrong(t *testing.T) {
	...
	_, _, err = migration.Load(ctx, log, "testdata/fail", "wrongfolder", 0, v, dss, false, false, nil)
	if err == nil {
		t.Errorf("Load should returns an error")
	}
}
...
func TestMigrationLoadWrongEngine(t *testing.T) {
	...
	_, _, err = migration.Load(ctx, log, "testdata/fail", "wrongengine", 0, v, dss, false, false, nil)
	if err == nil {
		t.Errorf("Load should returns an error")
	}
}
...
func TestMigrationLoadWrongQuery(t *testing.T) {
	...
	_, _, err = migration.Load(ctx, log, "testdata/fail", "wrongquery", 0, v, dss, false, false, nil)
	if err == nil {
		t.Errorf("Load should returns an error")
	}
}
...
func TestMigrationPostLoad(t *testing.T) {
	...
	_, steps, err := migration.Load(ctx, log, "testdata/good", "namemigrationok", 0, v, dss, false, false, nil)
	if err != nil {
		t.Errorf("Load should not returns an error, returned: %v", err)
	}
